<template>
  <div class="user">
    ...
    <input type="text" v-model="dataset.label" placeholder="label">
    <input type="text" v-model="dataset.language" placeholder="language">
  ...
  export default {
    ...
    methods: {
      ...
      createNewUser () {
        ...
        api.createUser(this.dataset.label, this.dataset.language).then(response => {
